...
class HandleInertiaRequests extends Middleware
{
    ...
    public function share(Request $request)
    {
        ...
        if(auth()->user() && auth()->user()->cart) {
            $singleProductCount = auth()->user()->cart->products()->where("diet_id", null)->count();
            $dietProductCount = auth()->user()->cart->products()->where("diet_id", "!=", null)->where("present", 1)->count();

            $countCart = $singleProductCount + $dietProductCount;
        }*/
