    ...
    <main class="inquiry-wrap inquiry faq">
        <div class="container">
            <div class="sub-top col-group">
                <ul class="col-group">
                    <li>
                        <a href="/shopping/faqs" class="row-group">
                            <h4>
                                FAQ
                            </h4>
                            <P>
                    ...
                    <li>
                        <a href="/shopping/notices" class="row-group active">
                            <h4>
                                NOTICE
                            </h4>
                            <P>
                    ...
                    <li v-for="notice in notices.data" :key="notice.id">
                        ...
                        <div class="ans">
                            <div class="col-group">
                                ...
                                <pre v-html="notice.description"></pre>
                            </div>
                        </div>
                    </li>
                </ul>
...
export default {
    ...
    methods:{
        filter(){
            this.form.get("/shopping/notices", {
                preserveScroll: true,
                preserveState: true,
                onSuccess: (page) => {
                    this.notices = page.props.notices;
                }
            });
        },
    },
