        ...
        <div class="container">
            ...
            <div class="post_navigaiton">
                <div class="post-pre-btn">
                    <a :href="`/datingNotices/${item.prev.id}`" v-if="item.prev">
                        <i class="xi-long-arrow-left"></i>
                        <span> 이전글</span>
                    </a>
                </div>
                <a href="/datingNotices"><button class="post-list-btn">목록</button></a>
                <div class="post-next-btn">
                    <a :href="`/datingNotices/${item.next.id}`" v-if="item.next">
                        <span> 다음글</span>
