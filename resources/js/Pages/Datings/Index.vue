                            ...
                            <ul class="date-detail">
                                ...
                                <li class="col-group">
                                    ...
                                    <div class="user">
                                        ...
                                        <a href="#" v-if="!dating.check_address && dating.ongoing && user.sex === '남자' && dating.city1" class="date-btn active" @click.prevent="targetSuggestAddressDating = dating">일정도착</a>

                                    </div>
                                </li>
                            </ul>
                            <!-- 데이트 최종 매칭 & 종료 -->
                            <a href="#" class="chat-btn active" v-if="!dating.ongoing && dating.check_address" @click="targetFeedbackDating = dating">
                                <p>후기 남기기</p>
                            </a>
                            <!-- 데이트 매칭 & 1일정 채팅 열림 -->
