    ...
    <main class="subpage blind-date">
        ...
        <div class="sub-container-blind">
            <div class="sub-container-contents">
                ...
                <img class="sub-line mb" src="/images/line.png" alt="line">
                <p>
        ...
        <div class="main-container">
            <div class="container">
                ...
                <div class="service-contents">
                    <img src="/images/crown3.png" alt="crown3">
                    <p class="title">인사 소개팅</p>
                    <p class="sub-title">서비스 절차</p>
                    <img src="/images/line-short.png" alt="line-short">
                    <div class="service-step">
                        <div class="step-box">
                            <img class="step-img" src="/images/service-icon-01.png" alt="service-icon-01">
                            <div class="squair">
                                <p>STEP 01</p>
                                <p>사전 상담</p>
                            </div>
                        ...
                        <div class="step-box">
                            <img class="step-img" src="/images/service-icon-02.png" alt="service-icon-01">
                            <div class="squair">
                                <p>STEP 02</p>
                                <p>프로필 작성</p>
                            </div>
                        ...
                        <div class="step-box">
                            <img class="step-img" src="/images/service-icon-03.png" alt="service-icon-01">
                            <div class="squair">
                                <p>STEP 03</p>
                                <p>소개팅 매칭</p>
                            </div>
                        ...
                        <div class="step-box">
                            <img class="step-img" src="/images/service-icon-04.png" alt="service-icon-01">
                            <div class="squair">
                                <p>STEP 04</p>
                                <p>프로필 교환</p>
                            </div>
                        ...
                        <div class="step-box box-right">
                            <img class="step-img" src="/images/service-icon-05.png" alt="service-icon-01">
                            <div class="squair">
                                <p>STEP 05</p>
                                <p>일정 조율</p>
                            </div>
                        ...
                        <div class="step-box box-right">
                            <img class="step-img" src="/images/service-icon-06.png" alt="service-icon-01">
                            <div class="squair">
                                <p>STEP 06</p>
                                <p>소개팅</p>
                            </div>
                        ...
                        <div class="step-box box-right">
                            <img class="step-img" src="/images/service-icon-07.png" alt="service-icon-01">
                            <div class="squair">
                                <p>STEP 07</p>
                                <p>피드백</p>
                            </div>
                        </div>
                        <div class="step-box box-right step-box8">
                            <img class="step-img" src="/images/service-icon-08.png" alt="service-icon-01">
                            <div class="squair">
                                <p>STEP 08</p>
                                <p>컨설팅</p>
                            </div>
                    ...
                    <div class="step-1">
                        ...
                        <p class="title">상담</p>
                        <p class="sub-title">좋은 인연을 찾기 위한 디테일한 1,2차 상담</p>
                        <div class="step-1-consult">
                            <img src="/images/consult-01.png" alt="consult-01">
                            <img src="/images/consult-02.png" alt="consult-02">
                            <img src="/images/consult-03.png" alt="consult-03">
                        </div>
                    </div>
                    <!-- step-2 -->
                    <div class="step-2">
                        ...
                        <p class="sub-title">
                            매력적으로 본인을 소개해 주시면, 디테일한 상담 내용을 토대로<br />
                            개인의 매력을 반영하여 매치스트들이 보완, 수정하여 프로필을 만듭니다.
                        </p>
                        <div class="step-2-consult">
                            <img src="/images/profile-01.png" alt="profile-01">
                            <img src="/images/profile-02.png" alt="profile-02">
                            <img src="/images/profile-03.png" alt="profile-03">
                        </div>
                    </div>
                    <!-- step-3 -->
                    <div class="step-3">
                        ...
                        <div class="step-3-consult">
                            <img src="/images/matching.png" alt="matching" class="matching-pc">
                            <img src="/images/matching-m.png" alt="matching" class="matching-m">
                    ...
                    <div class="step-4">
                        ...
                        <p class="sub-title">
                            매칭 확정 후, 소개팅 상대방과 소개팅 일정, 장소를 조율합니다.<br />
                            소개팅 확정 후 변경, 취소가 불가합니다.
                        </p>
                        <p class="warning-text">※ 지각, 비매너적인 행동은 회원 제명, 소개 횟수 차감으로 이어집니다.</p>
                        <div class="step-4-consult">
                            <img src="/images/calendar-01.png" alt="calendar-01">
                            <img src="/images/calendar-02.png" alt="calendar-02">
                        </div>
                    </div>
                    <!-- step-4 -->
                    <div class="step-4">
                        ...
                        <div class="step-4-consult">
                            <img src="/images/chat.png" alt="1:1채팅방">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="service-contents">
                <div class="step-6">
                    ...
                    <p class="warning-text">※ 추후 더 나은 소개팅을 위해 100% 소개팅 피드백을 진행하고 있습니다.</p>
                    <div class="step-6-consult">
                        <img src="/images/feedback-01.png" alt="feedback-01">
                        <img src="/images/feedback-02.png" alt="feedback-02">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="service-contents-price">
                    <div class="step-7-content">
                        ...
                        <img src="/images/line-short.png" alt="">
        ...
        <div class="container">
            <div class="service-contents-price refund-blind">
                <div class="step-7-content">
                    ...
                    <img src="/images/line-short.png" alt="">
                    <div class="refund-blind-box">
                        <p>인사(이하 '회사')가 제공하는 소개팅 서비스에 가입하기 위하여 계약 내용을 인지하고 이용금액을
                            결제함으로써 해당 서비스의 가입 및 계약이 성립됩니다. 회사의 가입기준에 따라서 가입이 제한
                            또는 거절될 수 있으며 그럴 경우에는 전액 환불 도와드리고 있습니다.</p>
                        <p><span>01.</span> 인사 가격표는 VAT가 포함된 가격이며, 정찰제로 운영됩니다.</p>
                        <p><span>02.</span> 프로그램은 연령대별로 가격이 상이합니다.</p>
                        <p><span>03.</span> 서비스 이용료 납부와 동시에 상담, 회원 등록, 매칭 등 소개팅 프로세스가 진행되기 때
                            문에 결제금액에서 이용금액과 위약금 20%를 제하고 환불 가능합니다.</p>
                        <p><span>04.</span> 첫 프로필 제공은 최소 2주가 소요됩니다.</p>
                        <p><span>05.</span> 첫 프로필 제공 후에 환불 요청 시에는 1회 차감 후 환불됩니다.</p>
                        <p><span>06.</span> 환불 가능 기간은 프로그램 기간동안이며, 환불액 산정은 남은 횟수/가입 횟수에 따라 산
                            정됩니다. (즉, 추가 서비스 횟수가 제공된 경우, 환불 시에 추가 서비스 횟수를 제외하고
                            산정됩니다.)</p>
                        <p><span>07.</span> 프로필 수령 후 24시간 내에 소개팅 날짜, 장소를 조율해주세요. 24시간 내에 무응답일
                            경우, 프로그램 진행 회피로 여겨 횟수 차감이나 불이익이 발생합니다</p>
                        <p><span>08.</span> 소개팅 확정 후에 취소나 변경 시에는 횟수 차감뿐만 아니라 프로그램 이용이 거절될 수
                            있습니다</p>
                        <p><span>09.</span> 회원권 이용기간은 프로그램 기간과 동일하며, 개인적인 사유(해외파견, 출장, 입원 등)로
                            추가 연장을 요구하는 경우는 최대 프로그램 기간만큼 유효하며 서류 증빙 후 가능합니
                            다. (단, 기간 연장의 경우 환불은 불가합니다.)</p>
                        <p><span>10.</span> 인사를 통해 교제하거나 성혼하게 된 경우, 이용 목적이 달성되는 것으로 프로그램 종료
                            이나 횟수가 남아 있으실 경우에는 가입하신 프로그램 기간만큼 연장 가능합니다.</p>
                        <p><span>11.</span> 회원 교제나 성혼의 이유로 이용이 불가할 때, 지인(신규회원)에게 양도 가능합니다</p>
                        <p><span>12.</span> 회원이 제출한 개인정보를 사실로 간주하며 허위로 의심되는 경우 진위 여부를 확인하기
                            위하여 당사자에게 정보에 관하여 증명을 요구할 수 있으며 허위의 사실을 제출한 경우
                            서비스의 이용을 제한하거나 거부할 수 있으며 손해배상을 청구할 수 있으며, 회사의 과
                            실과 책임은 없습니다.</p>
                    </div>
