    ...
    <main class="subpage post">
        <div class="container">
            <div class="post-header">
                <p class="post-header-title">{{ item.title }}</p>
                <p class="post-header-date">{{ item.created_at }}</p>
            </div>
            <div class="post-main">
            ...
            <div class="post_navigaiton">
                <div class="post-pre-btn">
                    <a :href="`/commentNotices/${item.prev.id}`" v-if="item.prev">
                        <i class="xi-long-arrow-left"></i>
                        <span> 이전글</span>
                    </a>
                </div>
                <a href="/commentNotices"><button class="post-list-btn">목록</button></a>
                <div class="post-next-btn">
                    <a :href="`/commentNotices/${item.next.id}`" v-if="item.next">
                        <span> 다음글</span>
